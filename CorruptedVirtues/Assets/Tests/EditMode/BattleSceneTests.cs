...
public class BattleSceneTests
{
    ...
    public class TransistionToState_Method 
    {
        ...
        [Test]
        public void Transition_To_startState()
        {
            _battleSystem.TransitionToState(_battleSystem.startState);
            Assert.That(_battleSystem.CurrentState, Is.EqualTo(_battleSystem.startState));
        }
